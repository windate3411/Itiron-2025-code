...
const testimonials = [
  {
    ...
    avatar: '👨‍💻',
    content:
      '使用 AI Interview Pro 練習了兩個月，成功拿到夢想公司的 offer！AI 的回饋非常專業且具體。',
    rating: 5,
  },
  {
    name: '王美華',
    ...
    avatar: '👩‍💻',
    content:
      '這個平台讓我在轉職過程中更有信心。程式實作的題目很貼近真實面試，幫助我發現了很多盲點。',
    rating: 5,
  },
  {
    name: '張志偉',
    ...
    avatar: '👨‍🎓',
    content:
      '隨時隨地都能練習，不用擔心打擾真人面試官。AI 的評分標準也很客觀，讓我知道該往哪個方向努力。',
    rating: 5,
  },
];
            ...
            <AnimatedCard delay={0}>
              <div className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-xl border border-gray-700 hover:border-blue-500 transition-all h-full">
                ...
                <p className="text-gray-400">
                  深入測試你對前端技術的理解，包括 JavaScript、React、CSS
                  等核心概念
                </p>
              </div>
            </AnimatedCard>
